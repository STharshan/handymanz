...
const WhyServiceWheelAlignment = () => {
  return (
    <section
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            >
              Correct wheel alignment and tracking are essential for vehicle safety, 
              performance, and long-term cost savings. Our advanced equipment and 
              skilled technicians ensure precise adjustments for a smoother, safer drive.
            </p>
          ...
          <div>
            ...
            >
              <h3
                ...
                style={{ color: "#7C2D12" }} // orange-900
              >
                Signs You Need Wheel Alignment or Tracking
              </h3>
              <ul className="space-y-4" style={{ color: "#9A3412" }}> {/* orange-800 */}
                {[
                  ...
                  "Tyres squealing during normal driving",
                ].map((sign, i) => (
...
export default WhyServiceWheelAlignment;
