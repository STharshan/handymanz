    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          >
            Expert clutch repair and replacement services to ensure smooth gear changes and reliable vehicle performance. Our skilled technicians accurately diagnose clutch issues and provide cost-effective solutions using quality parts.
          </p>
